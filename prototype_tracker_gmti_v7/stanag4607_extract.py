...
class Sink:
    def __init__(self, jsonl_path=None):
        ...
        self.platlocs = []          # positions porteur (lat, lon) — pour overlay/tracé
...
def extract(path, port=None, jsonl_path=None):
    ...
    Réutilisable (GUI/tests). Lève PcapngError sur pcapng, ValueError si format
    inconnu. Ignore les flux non-4607 (ex. vidéo MPEG-TS).
    """
